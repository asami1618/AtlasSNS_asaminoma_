        ...
        <li>
            ...
            <li class="button-area">
                <div>
                    ...
                    <!-- フォロー解除 -->
                        <button type="button"><a href="{{ route('unfollow' , $users->id) }}" class="btn btn-danger">フォロー解除</a></button>
                    @else
                    <!-- フォローする -->
                        <button type="button"><a href="{{ route('follow' , $users->id) }}" class="btn btn-primary">フォローする</a></button>
                    @endif
                </div>
            </li>
        </li>
